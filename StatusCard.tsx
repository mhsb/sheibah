...
const StatusCard: React.FC<StatusCardProps> = ({ status, message }) => {
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg p-6 max-w-md mx-auto mt-6 text-center transform transition-all duration-300 hover:scale-105">
      {getIcon()}
      ...
      <p className="text-gray-500 text-sm">{message || "لطفا شکیبا باشید"}</p>
    </div>
  );
};
