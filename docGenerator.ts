// We remove the static import because 'docx' is heavy and can crash the browser 
// if dependencies (like Buffer) aren't polyfilled perfectly before load.
...
export const generateMobileDocx = async (text: string): Promise<Blob> => {
  // Dynamic import ensures this code only runs when the user actively clicks "Convert"
